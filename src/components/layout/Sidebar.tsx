...
export function Sidebar() {
  const { sidebarCollapsed, toggleSidebar, lang } = useApp()
  ...
  return (
    <aside
      className={cn(
        'flex shrink-0 flex-col overflow-hidden bg-[var(--bg-sidebar)] border-r border-[var(--border)] transition-[width] duration-300 ease-in-out',
